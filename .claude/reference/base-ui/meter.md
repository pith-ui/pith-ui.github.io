...
| style     | `CSSProperties \| ((state: Meter.Track.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
...
| style     | `CSSProperties \| ((state: Meter.Indicator.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
...
| style     | `CSSProperties \| ((state: Meter.Value.State) => CSSProperties \| undefined)`    | -       | \*                                                                                                                                                                                           |
...
| style     | `CSSProperties \| ((state: Meter.Label.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
