...
| style     | `CSSProperties \| ((state: Progress.Track.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
...
| style     | `CSSProperties \| ((state: Progress.Indicator.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
...
| style     | `CSSProperties \| ((state: Progress.Value.State) => CSSProperties \| undefined)`    | -       | \*                                                                                                                                                                                           |
...
| style     | `CSSProperties \| ((state: Progress.Label.State) => CSSProperties \| undefined)`    | -       | -                                                                                                                                                                                            |
